...
A ready-to-use `.agents` folder for **Ionic + Angular** projects, including all Angular and Ionic skills, shared skills, all rules, and the full agent library.
...
- **Skills** — angular (all), ionic, code-review, commit-and-pr, css, orchestrate-dev-team, rxjs, typescript
