...
A ready-to-use `.agents` folder for **NestJS** projects, including all NestJS skills, shared skills, all rules, and the full agent library.
...
- **Skills** — nestjs (core, config, logging), code-review, commit-and-pr, orchestrate-dev-team, rxjs, typescript
